...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    private fun onaddAllData() {
        ...
        headphoneList.add(ChildItemDataClass(R.drawable.headphone,"Super Mic Headphone","wireless headphone with quality mic",4.5,"(13)"))
        headphoneList.add(ChildItemDataClass(R.drawable.headphone,"Super Mic Headphone","wireless headphone with quality mic",4.5,"(13)"))
        headphoneList.add(ChildItemDataClass(R.drawable.headphone,"Super Mic Headphone","wireless headphone with quality mic",4.5,"(13)"))
        headphoneList.add(ChildItemDataClass(R.drawable.headphone,"Super Mic Headphone","wireless headphone with quality mic",4.5,"(13)"))
        headphoneList.add(ChildItemDataClass(R.drawable.headphone,"Super Mic Headphone","wireless headphone with quality mic",4.5,"(13)"))
        ...
        tshirtList.add(ChildItemDataClass(R.drawable.t_shirt,"Printed Cotton T-Shirt","printed cotton t-shirt in multiple colors",4.0,"(10)"))
        tshirtList.add(ChildItemDataClass(R.drawable.t_shirt,"Printed Cotton T-Shirt","printed cotton t-shirt in multiple colors",4.0,"(10)"))
        tshirtList.add(ChildItemDataClass(R.drawable.t_shirt,"Printed Cotton T-Shirt","printed cotton t-shirt in multiple colors",4.0,"(10)"))
        tshirtList.add(ChildItemDataClass(R.drawable.t_shirt,"Printed Cotton T-Shirt","printed cotton t-shirt in multiple colors",4.0,"(10)"))
        tshirtList.add(ChildItemDataClass(R.drawable.t_shirt,"Printed Cotton T-Shirt","printed cotton t-shirt in multiple colors",4.0,"(10)"))
        ...
        phoneList.add(ChildItemDataClass(R.drawable.iphone,"Mobile with top features","think different",5.0,"(16)"))
        phoneList.add(ChildItemDataClass(R.drawable.iphone,"Mobile with top features","think different",5.0,"(16)"))
        phoneList.add(ChildItemDataClass(R.drawable.iphone,"Mobile with top features","think different",5.0,"(16)"))
        phoneList.add(ChildItemDataClass(R.drawable.iphone,"Mobile with top features","think different",5.0,"(16)"))
        phoneList.add(ChildItemDataClass(R.drawable.iphone,"Mobile with top features","think different",5.0,"(16)"))
