    ...
    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
      <div className="py-1">
        <Link
          ...
          className="text-green-600 hover:text-green-700 block px-4 py-2 text-sm">
          Fashion
        </Link>
        <Link
      ...
      <Link
        to="/cart"
        className="text-green-600 hover:text-green-700 px-3 py-2 rounded-md text-lg font-medium flex items-center">
