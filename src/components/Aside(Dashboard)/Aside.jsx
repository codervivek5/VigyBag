    ...
    <aside
      ...
      <nav className="flex-1 px-4 py-8 space-y-2">
        ...
        <a
          ...
          <FaShoppingCart />
          <span>My Cart</span>
          <span className="absolute right-2 top-1 bg-red-500 text-xs text-white rounded-full w-5 h-5 flex items-center justify-center">
            5
          </span>
        </a>
        <a
        ...
        <a
          href="#"
          className="flex items-center space-x-2 p-2 relative justify-center">
          <button
