...
const ReturnAndCancellation = () => {
  ...
  return (
    <div className="bg-[#fff0e3ff] text-gray-800 p-4 md:p-8">
      <div className="max-w-6xl mx-auto bg-white shadow-md p-4 md:p-8 rounded-lg"style={{border:'2px solid black'}}>
        <main>
          <div className="mb-8">
            <h1 className="text-xl md:text-2xl font-bold mb-4 text-center "style={{color:'forestgreen'}}>Return and Cancellation</h1>
          {/*  <hr className="border-black w-1/2 mx-auto mb-4 -mt-3"style={{border:'1px solid black'}} /> */}
          </div>

          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">Cancellation Policy</h2>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              order. <b>VigyBag</b> also reserves the right to waive off or modify
              the time window or cancellation fee from time to time.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-4">Returns Policy</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h3 className="text-xl md:text-2xl font-semibold mb-4">Part 1 – Category, Return Window and Actions possible</h3>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-300">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="border border-gray-300 p-2 text-left">Category</th>
                    <th className="border border-gray-300 p-2 text-left">Returns Window, Actions Possible and Conditions (if any)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <tr>
                    <td className="border border-gray-300 p-2">Medicine (Allopathy & Homeopathy)</td>
                    <td className="border border-gray-300 p-2">
                      2 days
                      <br />
                      Refund
                  ...
                  <tr>
                    <td className="border border-gray-300 p-2">No Questions Asked</td>
                    <td className="border border-gray-300 p-2">
                      10 days
                      <br />
                      Refund or replacement
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 p-2">
                      ...
                      Replacement only
                      <br />
                      To help you resolve issues with your product,
                      we may troubleshoot your product either through online tools,
                      over the phone, and/or through an in-person technical visit.
                      <br />
                      If a defect is determined within the Returns Window,
                      a replacement of the same model will be provided at no additional cost.
                      If no defect is confirmed or the issue is not diagnosed within 7 days of delivery,
                      you will be directed to the warranty partner for resolving any subsequent issues.
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <section className="mb-8">
            <h3 className="text-xl md:text-2xl font-semibold mb-4">Part 2 - Returns Pick-Up and Processing</h3>
            <p className="mb-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-300">
                ...
                <tbody>
                  <tr>
                    <td className="border border-gray-300 p-2">Correct Product</td>
                    <td className="border border-gray-300 p-2">
                  ...
                  <tr>
                    <td className="border border-gray-300 p-2">Complete Product</td>
                    <td className="border border-gray-300 p-2">
                  ...
                  <tr>
                    <td className="border border-gray-300 p-2">Unused Product</td>
                    <td className="border border-gray-300 p-2">
                  ...
                  <tr>
                    <td className="border border-gray-300 p-2">Undamaged Product</td>
                    <td className="border border-gray-300 p-2">
                  ...
                  <tr>
                    <td className="border border-gray-300 p-2">Undamaged Packaging</td>
                    <td className="border border-gray-300 p-2">
          ...
          <section className="mb-8">
            <h3 className="text-xl md:text-2xl font-semibold mb-4">Part 3 - General Rules for a successful Return</h3>
