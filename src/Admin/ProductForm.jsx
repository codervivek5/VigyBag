...
const ProductForm = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'basic':
        return (
          <>
            ...
            <TextArea label="Product Description" placeholder="Describe your product" />
      ...
      case 'pricing':
        return (
          <>
            <PriceInput label="Price (₹)" value={price} onChange={handlePriceChange} />
            <PriceInput label="Discounted Price (₹)" value={discountedPrice} onChange={handleDiscountedPriceChange} />
            <InputField label="Currency" placeholder="INR" value="INR" readOnly />
            <InputField label="Stock Quantity" type="number" placeholder="0" />
            <InputField label="Minimum Order Quantity" type="number" placeholder="1" />
            <InputField label="Maximum Order Quantity" type="number" placeholder="Optional" />
          </>
        );
      case 'images':
        return (
          <>
            ...
            <FileInput label="Additional Images (Max 3)" accept="image/*" multiple maxFiles={3} />
      ...
      case 'shipping':
        return (
          <>
            ...
            <InputField label="Shipping Options" placeholder="e.g., Standard, Express" />
            <InputField label="Shipping Cost" type="number" placeholder="0.00" />
          </>
        );
      case 'seo':
        return (
          <>
            ...
            <InputField label="Keywords" placeholder="Comma-separated keywords" />
            <TextArea label="Specifications" placeholder="Product specifications" />
      ...
      case 'additional':
        return (
          <>
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-600 mb-1">Availability Status</label>
              <select className="w-full p-2 border-b border-gray-300 focus:border-blue-500 focus:outline-none">
            ...
            <TextArea label="Warranty Information" placeholder="Warranty details" />
            <TextArea label="Return Policy" placeholder="Return policy details" />
            <InputField label="Country of Origin" placeholder="Manufacturing country" />
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 bg-white shadow-lg rounded-lg mt-1 mb-3 ">
      <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-center text-gray-800">Product Information</h1>
