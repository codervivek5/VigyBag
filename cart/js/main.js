  ...
  if (cart.length > 0) {
    ...
    function addProduct(target) {
      ...
      var productAdded =
        ...
        '<li class="cd-cart__product"><div class="cd-cart__image"><a href="#0"><img src="./cart/img/product-preview.png" alt="placeholder"></a></div><div class="cd-cart__details"><h3 class="truncate"><a href="#0">Product Name</a></h3><span class="cd-cart__price">$25.99</span><div class="cd-cart__actions"><a href="#0" class="cd-cart__delete-item"><i class="fa-solid fa-trash"></i></a><div class="cd-cart__quantity"><label for="cd-product-' +
        productId +
