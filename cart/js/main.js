(function () {
  ...
  if (cart.length > 0) {
    ...
    function addProduct(target) {
      ...
      var productCard = target.closest('.item-description-2');
      var productName =
        productCard.querySelector('.item-heading a').textContent;
      var productPrice =
        productCard.querySelector('.item-heading h3').textContent;
      ...
      var productAdded =
        ...
        '<a href="#0" class="cd-cart__delete-item"><i class="fa-solid fa-trash"></i></a>' +
        '<div class="cd-cart__quantity">' +
        '<label for="cd-product-' +
        productId +
        '">Qty</label>' +
        '<span class="cd-cart__select"><select class="reset" id="cd-product-' +
        productId +
        '" name="quantity">' +
        ...
        '</select><polyline fill="none" stroke="currentColor" points="2,4 6,8 10,4"/></svg></span>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</li>';

      // Insert the product card into the cart
